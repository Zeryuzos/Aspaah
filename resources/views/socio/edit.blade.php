    ...
    <form action="/socios/{{$socio->id}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <div class="row">
                <div class="col-md-12">
                <div class="row">
                    <div class="col-md-4 col-12 mb-4 flex items-center justify-center position-relative">
                        <div class="d-flex position-relative opacity_image" style="max-height: 250px; max-width: 210px;">
